...
when 'amazon'
  ...
  default['yum']['epel-testing-source']['gpgkey'] = 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-EPEL-6'
else
  ...
  when 5
    ...
    default['yum']['epel-testing-source']['gpgkey'] = 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-EPEL'
  when 6
  ...
  when 7
    ...
    default['yum']['epel-testing-source']['gpgkey'] = 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-EPEL-7'
  end
end
